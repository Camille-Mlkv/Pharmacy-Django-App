...
from .models import Contact, Article, Vacancy, Question, PromoCode, News, User, PickupPoint, Medication, Purchase, Customer, Employee, Admin, PharmacyDepartment, Supplier, Sale, FeedBack
...
class PickupPointTest(TestCase):
    def setUp(self):
    ...
    def test_pickup_point_str(self):
        """Тестирование метода __str__ модели PickupPoint"""
...
class MedicationTest(TestCase):
    ...
    def test_medication_str(self):
        """Тестирование метода __str__ модели Medication"""
        expected_str = 'Test Medication 12345 (10.0 рублей)'
        self.assertEqual(str(self.medication), expected_str)
...
from pharmacy.forms import EmployeeSignUpForm
